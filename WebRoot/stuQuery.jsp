<%@ page language="java" import="java.util.*" pageEncoding="UTF-8" import="java.util.ArrayList,PO.Stu" %>
<%
      ...
      <section id="content">
        <section class="vbox">
          <section class="scrollable padder">
            ...
            <div class="m-b-md">
            <span>你要查询的数据表中共有<%=request.getSession().getAttribute("stucount")%>个学生</span>
              <table border="1px" width="80%" align="center">
            		<tr><th>编号</th><th>学号</th><th>姓名</th><th>年龄</th><th>性别</th><th>班级</th><th>密码</th></tr>
            		<%
                ArrayList list=(ArrayList)session.getAttribute("stuallInfo");  
                if(list.isEmpty()){  
                    %>  
                    <tr>  
                        <td align="center">  
                    ...
                    for(int i=0;i<list.size();i++){  
                        ...
                        <tr>  
                            ...
                            <td><%=info.getStuage()%></td>
                            <td><%=info.getStusex()%></td>
                            <td><%=info.getStuclass()%></td>
                            <td><%=info.getStupassword()%></td>
                        </tr>  
                        <%  
                    }  
                }  
